...
You will see a "Try it now" section. Inside the text field it should have 
"pokemon/ditto/".
If you don't see data below the label "Resource for ditto", you will need to click 
the blue "submit" button.
At the bottom of the section where the data is presented there is a small checkbox 
labeled "View raw JSON". Check it.
...
var pokeditto = {
  ...
  var abi = pokeditto.abilities;
  var be = pokeditto.base_experience;
  var he = pokeditto.height;
  
  var hi =  pokeditto.held_items.item[0].item.url;
  var spr = pokeditto.sprites;
  var stnam = pokeditto.stats[0].stat.name;
  var ty = pokeditto.types[0].slot;
  var w = (pokeditto.weight * 0.0022);
  var firstVerGr = pokeditto.moves[0].version_group_details;
  console.log(abi)
  console.log(be)
  console.log(he)
  console.log(hi)
